...
export default {
  ...
  methods: {
    ...
    async createPool(pool, masterContract) {
      ...
      console.log("display oracle info here");
      console.log(pool.token.oracleId);
      ...
      // };
      console.log("oracleExchangeRate!!!");
      console.log(oracleExchangeRate);

      const contractExchangeRate = await this.getContractExchangeRate(
        poolContract
      );
      console.log("ContractExchangeRate!!!");
      console.log(contractExchangeRate);
    ...
    async getOracleExchangeRate(
      ...
      console.log("display oracle info here again");
      console.log(oracleContractInfo.address);
      ...
      try {
        ...
        console.log("oracleContract.addresssssssss");
        console.log(oracleContract.address);
        const rate0 = await oracleContract.peekSpot();
        console.log(rate0);
